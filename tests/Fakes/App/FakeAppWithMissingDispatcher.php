...
/**
 * A DI-aware app whose "dispatcher" service resolves to something that
 * isn't a Dispatcher, driving FunctionalTrait::dispatcher()'s MissingService
 * branch.
 */
final class FakeAppWithMissingDispatcher implements InjectionAwareInterface
{
